...
<div id="stage">
    ...
    <div id="credits">
        <ol class="crew" id="one">
            ...
            <li data-details="Christine Burwinkle &mdash; Technical writer"><strong><span>Christine Burwinkle &mdash; Technical writer</span></strong></li>
        ...
        <ol class="crew" id="five">
            ...
            <li data-details="Renjith Pillai &mdash; support"><strong><span>Renjith Pillai &mdash; support</span></strong></li>
