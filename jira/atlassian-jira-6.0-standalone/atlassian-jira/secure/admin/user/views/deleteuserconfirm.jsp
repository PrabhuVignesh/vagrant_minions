...
<body>
        ...
        <ww:if test="deleteable == 'true'">
            <page:applyDecorator id="delete_user_confirm" name="auiform">
                ...
                <aui:component template="formHeading.jsp" theme="'aui'">
                    <aui:param name="'text'"><ww:text name="'admin.deleteuser.delete.user'"/>: <ww:property value="name" escape="false" /></aui:param>
                </aui:component>
    ...
    <ww:else>
        <h2><ww:text name="'admin.deleteuser.delete.user'"/>: <ww:property value="name" escape="false" /></h2>
        <aui:component template="auimessage.jsp" theme="'aui'">
            <aui:param name="'messageType'">error</aui:param>
            <aui:param name="'messageHtml'">
